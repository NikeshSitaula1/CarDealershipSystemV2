...
import com.pluralsight.BankingCalculator;
import com.pluralsight.Vehicle;

public class LeaseContract extends com.pluralsight.contracts.Contract {
    ...
    public static com.pluralsight.contracts.Contract buildFromEncodedData(String encodedData){
    ...
    public double getMonthlyPayment() {
        ...
        return BankingCalculator.calculateLoanPayment(this.getTotalPrice(), financeRate, financeTerm);
    }
