...
public class ContractFileManager {
    ...
    public static ArrayList<com.pluralsight.contracts.Contract> getFromCSV(String filename){

        ArrayList<com.pluralsight.contracts.Contract> results = new ArrayList<>();
    ...
    public static void saveToCSV(ArrayList<com.pluralsight.contracts.Contract> contracts, String filename){

        try {
            //Creating a file writer and assigning the file writer to the buffered writer.
            FileWriter fw = new FileWriter(filename);
            BufferedWriter bw = new BufferedWriter(fw);
            for(com.pluralsight.contracts.Contract c : contracts){
                bw.write(c.encode() + "\n");
            }
    ...
    public static void appendToCSV(com.pluralsight.contracts.Contract contract, String filename){
        try {
            //Creating a file writer and assigning the file writer to the buffered writer.
